...
import { products, categories, brands, productVariants, productImages, reviews } from '../../../db/schema.js';
...
export class CatalogService {
  ...
  static async getProductById(id: string) {
    ...
    const [productRes, variantsRes, imagesRes, reviewsRes] = await Promise.all([
