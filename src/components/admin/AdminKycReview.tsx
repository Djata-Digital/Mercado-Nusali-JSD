...
import { ShieldCheck, CheckCircle2, XCircle, AlertTriangle, FileText, Eye, User, Sparkles, Loader2 } from 'lucide-react';
import { AdminService } from '../../services/adminService';
import { KycReviewRecord } from '../../data/mockAdminKyc';
...
export const AdminKycReview: React.FC<AdminKycReviewProps> = ({ showToast }) => {
  ...
  const handleApprove = async (id: string) => {
    try {
      ...
      showToast(`Documento KYC #${id} aprovado.`);
    }
    setSelectedDoc(null);
  };
  ...
  const handleReject = async (id: string) => {
    try {
      ...
      showToast(`Documento KYC #${id} rejeitado.`);
    }
    setSelectedDoc(null);
  };
