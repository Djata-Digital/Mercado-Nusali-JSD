    ...
    <div className="space-y-6">
      ...
      {brands.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-12 text-center text-gray-400 space-y-2">
          <Tag className="w-10 h-10 mx-auto text-gray-300 stroke-1" />
          <p className="font-bold text-sm text-gray-600">Nenhuma marca registrada</p>
          <p className="text-xs text-gray-400 max-w-sm mx-auto">
            Nenhuma marca oficial foi cadastrada no catálogo. Clique no botão acima para registrar a primeira marca.
          </p>
        </div>
      ) : (
