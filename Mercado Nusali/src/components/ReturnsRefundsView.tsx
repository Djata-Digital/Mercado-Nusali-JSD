...
export const ReturnsRefundsView: React.FC = () => {
  ...
  const getReturnLabelData = (ret: BuyerReturn): ShippingLabelData => ({
    shipmentId: `ret_${ret.id}`,
    trackingNumber: ret.trackingLabelCode,
    orderNumber: ret.orderId,
    fulfillmentMode: 'REVERSE_LOGISTICS',
    productTitle: `Devolução: ${ret.productTitle}`,
    quantity: 1,
    carrier: 'Logística Reversa Nusali',
    recipientName: 'Centro de Triagem & Devoluções Nusali',
    recipientAddress: {
      street: 'Av. dos Combatentes da Liberdade, HUB Bandim - Bloco C',
      city: 'Bissau',
      countryCode: 'GW',
      phone: '+245 955000111',
    },
    senderName: 'Cliente Comprador Nusali',
    senderAddress: {
      street: 'Endereço Residencial do Comprador',
      city: 'Bissau',
      countryCode: 'GW',
    },
  });
