    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 animate-fadeIn">
      ...
      {isLoading ? (
        <div className="p-12 text-center text-gray-500 bg-white rounded-2xl border border-gray-200 shadow-2xs">
          <RefreshCw className="w-8 h-8 mx-auto mb-2 text-purple-600 animate-spin" />
          <p className="text-xs font-bold">Carregando cupons de desconto...</p>
        </div>
      ) : coupons.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center shadow-2xs space-y-3">
          <Tag className="w-10 h-10 text-gray-300 mx-auto" />
          <h3 className="font-bold text-sm text-gray-800">Nenhum cupom ativo na sua conta</h3>
          <p className="text-xs text-gray-500 max-w-sm mx-auto">
            Digite um código promocional válido no campo acima para resgatar seu cupom de desconto.
          </p>
        </div>
      ) : (
