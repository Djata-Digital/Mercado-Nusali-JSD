...
export const SellerSettingsHelp: React.FC<SellerSettingsHelpProps> = ({
  ...
  const faqs = [
    ...
    { q: 'Quais são os prazos e tarifas de saque?', a: 'Prazo e tarifa serão informados antes da confirmação do saque, dependendo do provedor, país e método selecionado.' },
