      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        >
          ...
          <span className="text-2xl font-black text-gray-900">
            {overview?.metrics?.activeOrdersCount ?? 0}
          </span>
        </div>
        ...
        >
          ...
          <span className="text-2xl font-black text-emerald-700">
            {formatCurrency(overview?.metrics?.walletBalance ?? 0, selectedCurrency)}
          </span>
        </div>
        ...
        >
          ...
          <span className="text-2xl font-black text-gray-900">
            {overview?.metrics?.totalCouponsCount ?? 0}
          </span>
        </div>
        ...
        >
          ...
          <span className="text-2xl font-black text-gray-900">
            {overview?.metrics?.favoritesCount ?? 0}
          </span>
        </div>
      </div>
